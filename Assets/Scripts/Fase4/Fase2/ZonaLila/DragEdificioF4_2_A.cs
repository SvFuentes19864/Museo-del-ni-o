...
public class DragEdificioF4_2_A : MonoBehaviour
{
    public GameManager gameManager;

    public SpawnF4_2_A spawnF4_2_A;
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning(
                "No se encontró Renderer en Edificio A."
            );
            return;
        }
    ...
    void OnMouseUp()
    {
        ...
        if (zonaCorrecta != null)
        {
            ...
            if (distancia < 3f)
            {
                ...
                if (spawnF4_2_A != null)
                {
                    spawnF4_2_A.ActivarParte2A();
                }

                Debug.Log(
                    "¡Edificio A colocado correctamente!"
                );
            }
        }
    }
