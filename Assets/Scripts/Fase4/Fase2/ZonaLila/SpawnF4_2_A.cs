...
public class SpawnF4_2_A : MonoBehaviour
{
    ...
    public void ActivarParte2A()
    {
        StartCoroutine(AparecerParte2A());
    }

    IEnumerator AparecerParte2A()
    {
        if (audioCiudad != null)
        {
            audioCiudad.Play();
        ...
        yield return StartCoroutine(SpawnGrupo(
        ...
        {
            controlProgresionF4.MostrarParqueJocotenangoConDelay();
        }
    }
