...
public class SpawnF4_2_B : MonoBehaviour
{
    ...
    public void ActivarParte2B()
    {
        StartCoroutine(AparecerParte2B());
    }

    IEnumerator AparecerParte2B()
    {
        if (audioCiudad != null)
        {
            audioCiudad.Play();
        ...
        {
            controlProgresionF4.MostrarAcueductoConDelay();
        }
    }
