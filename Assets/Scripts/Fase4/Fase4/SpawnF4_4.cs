...
public class SpawnF4_4 : MonoBehaviour
{
    ...
    )
    {
        ...
        {
            escalas[i] =
                objetos[i].transform.localScale;

            objetos[i].SetActive(false);
        }
    }

    public void ActivarParte4()
    {
        StartCoroutine(
            AparecerParte4()
        );
    ...
    IEnumerator AparecerParte4()
    {
        ...
        {
            controlProgresionF4.MostrarMunicipalidadConDelay();
        }
    }
