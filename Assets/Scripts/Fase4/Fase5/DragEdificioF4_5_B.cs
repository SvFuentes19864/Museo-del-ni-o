...
public class DragEdificioF4_5_B : MonoBehaviour
{
    public GameManager gameManager;

    public SpawnF4_5_B spawnF4_5_B;
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning(
                "No se encontró Renderer en Edificio F4_5_B."
            );
            return;
        }
    ...
    void OnMouseUp()
    {
        ...
        if (zonaCorrecta != null)
        {
            ...
            if (distancia < 3f)
            {
                ...
                if (spawnF4_5_B != null)
                {
                    spawnF4_5_B.ActivarParte5B();
                }

                Debug.Log(
                    "¡Edificio F4_5_B colocado correctamente!"
                );
            }
        }
    }
