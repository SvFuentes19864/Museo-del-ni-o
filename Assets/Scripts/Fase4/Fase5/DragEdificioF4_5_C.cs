...
public class DragEdificioF4_5_C : MonoBehaviour
{
    public GameManager gameManager;

    public SpawnF4_5_C spawnF4_5_C;
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning(
                "No se encontró Renderer en Edificio F4_5_C."
            );
            return;
        }
    ...
    void OnMouseUp()
    {
        ...
        if (zonaCorrecta != null)
        {
            ...
            if (distancia < 3f)
            {
                ...
                if (spawnF4_5_C != null)
                {
                    spawnF4_5_C.ActivarParte5C();
                }

                Debug.Log(
                    "¡Edificio F4_5_C colocado correctamente!"
                );
            }
        }
    }
