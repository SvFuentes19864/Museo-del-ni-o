...
public class SpawnF4_5_A : MonoBehaviour
{
    ...
    public void ActivarParte5A()
    {
        StartCoroutine(AparecerParte5A());
    }

    IEnumerator AparecerParte5A()
    {
        if (audioCiudad != null)
        {
            audioCiudad.Play();
        ...
        {
            controlProgresionF4.MostrarTorreReformadorConDelay();
        }
    }
