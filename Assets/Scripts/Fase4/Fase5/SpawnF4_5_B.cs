...
public class SpawnF4_5_B : MonoBehaviour
{
    ...
    public void ActivarParte5B()
    {
        StartCoroutine(AparecerParte5B());
    }

    IEnumerator AparecerParte5B()
    {
        if (audioCiudad != null)
        {
            audioCiudad.Play();
        ...
        yield return StartCoroutine(SpawnGrupo(edificiosPrincipales, escalasEdificios, audioEdificios, tiempoSpawnEdificios));
        yield return StartCoroutine(SpawnGrupo(cuadras, escalasCuadras, audioCuadras, tiempoSpawnCuadras));
